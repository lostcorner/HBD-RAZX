...
预览地址来自 Apple 的公开搜索结果，播放器界面由本页面控制，因此不会显示歌名和歌手。预览是否存在取决于 Apple 的地区目录和歌曲匹配结果；没有预览的记录仍保留在档案页，暂不进入 quiz。Apple Music、网易云、QQ 音乐和 Spotify 的其他入口目前仍按歌名和歌手生成搜索链接。
